...
class BusyLoader extends StatefulWidget {
  const BusyLoader({super.key, this.size = 160, this.showbackground = false});
  final double size;
      ...
      child: FittedBox(
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            color:
                // widget.showbackground ? AppColor.white :
                Colors.transparent,
          ),
            ...
            children: [
              ...
              SizedBox(
                ...
                child: Row(
                  ...
                  children: [
                    AniMatedItem(active: aniindex == 0, size: widget.size),
                    AniMatedItem(active: aniindex == 1, size: widget.size),
                    AniMatedItem(active: aniindex == 2, size: widget.size),
                    AniMatedItem(active: aniindex == 3, size: widget.size),
                  ],
                ),
              ),
            ],
...
class AniMatedItem extends StatelessWidget {
  const AniMatedItem({super.key, required this.active, required this.size});
